...
describe('renderPostMatchHtml (web mvp)', () => {
  ...
  it('renders fight army context and encounter losses in the inspector event impact block', () => {
    ...
    const summaryIndex = html.indexOf('Event summary');
    const lossesIndex = html.indexOf('Encounter loss details');
    const armyIndex = html.indexOf('Event window army lists');
    ...
    expect(html).toContain('Window start active military');
    expect(html).toContain('Window end active military');
    ...
    expect(html).toContain('Longbowman <span class="event-impact-item-count">x12</span>');
    expect(html).toContain('Knight <span class="event-impact-item-count">x2</span>');
    expect(html).toContain('Knight <span class="event-impact-item-count">x1</span>');
    ...
    expect(html).toContain('Spearman <span class="event-impact-item-count">x2</span>');
    expect(html).toContain('Knight <span class="event-impact-item-count">x1</span>');
    ...
    expect(summaryIndex).toBeGreaterThan(headlineIndex);
    expect(lossesIndex).toBeGreaterThan(summaryIndex);
    expect(armyIndex).toBeGreaterThan(eventIndex);
    expect(armyIndex).toBeGreaterThan(lossesIndex);
